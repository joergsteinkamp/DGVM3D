...
| FPC         | numeric   | value of cohort foliar projected cover |
...
The individual trees are by default randomly distributed within the inner radius of each patch hexagon (`establishPatch`). 
With the function 
